...
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  ...
  'today', 'Sales', 'East Coast', 1, '$100,000', 'Week', 'Salary', true, '1', 'mwwz0bjpsdrqiuuldkmy', 'chris123@fakemail.com');
INSERT INTO employees
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId, personal_email)
  ...
  'today', 'Sales', 'East Coast', 1, '$100,000', 'Week', 'Salary', true, '1', 'mwwz0bjpsdrqiuuldkmy', 'artem123@fakemail.com');
INSERT INTO employees
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId, personal_email)
  ...
  'today', 'Sales', 'East Coast', 2, '$60,000', 'Every other week', 'Salary', false, '1', 'mwwz0bjpsdrqiuuldkmy', 'janelle@fakemail.com');
INSERT INTO employees
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId, personal_email)
  ...
  'today', 'Sales', 'East Coast', 2, '$100,000', 'Week', 'Salary', false, '1', 'mwwz0bjpsdrqiuuldkmy', 'brent@fakemail.com');
INSERT INTO employees
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId, personal_email)
  ...
  'today', 'Sales', 'East Coast', 3, '$100,000', 'Week', 'Salary', false, '1', 'mwwz0bjpsdrqiuuldkmy', 'aloralyn@fakemail.com');
