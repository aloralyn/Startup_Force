...
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId)
  ...
  'today', 'Sales', 'East Coast', 1, '$100,000', 'Week', 'Salary', true, 'password', 'mwwz0bjpsdrqiuuldkmy');
INSERT INTO employees
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId)
...
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  ...
  'today', 'Sales', 'East Coast', 2, '$60,000', 'Every other week', 'Salary', false, 'password', 'mwwz0bjpsdrqiuuldkmy');
INSERT INTO employees
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId)
  ...
  'today', 'Sales', 'East Coast', 2, '$100,000', 'Week', 'Salary', false, 'password', 'mwwz0bjpsdrqiuuldkmy');
INSERT INTO employees
(company_id, first_name, last_name, preferred_name, dob, ssn, gender, street_1, street_2, city, zip_code, state, email, phone_number,
  linkedin_url, position, employee_status, start_date, department, division, reports_to, wage, pay_per, pay_type, is_manager, pw, profilePicId)
  ...
  'today', 'Sales', 'East Coast', 3, '$100,000', 'Week', 'Salary', false, 'password', 'mwwz0bjpsdrqiuuldkmy');
